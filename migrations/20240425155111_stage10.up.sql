...
CREATE TABLE cuentas (
    ...
    clasificacion clasificacion_cuenta DEFAULT 'capitulo',
    grupo grupo_cuenta DEFAULT 'activo',
    finalidad finalidad_cuenta DEFAULT 'otros',
    naturaleza naturaleza_cuenta DEFAULT 'deudora',
    afectable BOOLEAN DEFAULT FALSE,
    padre VARCHAR(30) NOT NULL,
    nivel INTEGER NOT NULL,
    en_balance BOOLEAN DEFAULT FALSE,
    ...
    subcuenta_siti BOOLEAN DEFAULT FALSE,
    prorrateo BOOLEAN DEFAULT FALSE
);