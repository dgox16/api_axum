CREATE TABLE avales_persona (
    id_persona_aval SERIAL PRIMARY KEY,
    id_persona INTEGER NOT NULL,
    clasificacion clasificacion_persona NOT NULL,
    socio_migrado VARCHAR(50) NOT NULL,
    ...
    usuario_bloqueo INTEGER NOT NULL,
    ...
    FOREIGN KEY (usuario_bloqueo) REFERENCES usuarios (id) ON DELETE RESTRICT
);
