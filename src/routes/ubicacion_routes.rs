...
use crate::{
    handlers::ubicacion_handlers::{
        ...
        buscar_domicilios_handler, buscar_estado_handler, buscar_municipios_handler,
        buscar_pais_handler, crear_nueva_calle_handler, crear_nueva_ciudad_handler,
        crear_nuevo_barrio_handler, crear_nuevo_domicilio_handler, crear_nuevo_municipio_handler,
    },
    AppState,
};
...
pub fn ubicacion_router(app_state: Arc<AppState>) -> Router {
    Router::new()
        ...
        .route("/api/domicilio/buscar", get(buscar_domicilios_handler))
        .route("/api/municipio/nuevo", post(crear_nuevo_municipio_handler))
        .route("/api/municipio/buscar", get(buscar_municipios_handler))
