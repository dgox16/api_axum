...
use crate::{schemas::persona_schemas::persona_menor_schema::CrearPersonaMenorSchema, AppState};

pub async fn validar_nueva_persona_menor(
    data: &Arc<AppState>,
    id_persona: i32,
    body: &CrearPersonaMenorSchema,
