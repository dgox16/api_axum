...
use crate::{
    schemas::persona_schemas::persona_proveedor_recursos_schemas::CrearPersonaProveedorRecursosSchema,
    AppState,
};

pub async fn validar_nueva_persona_proveedor_recursos(
    data: &Arc<AppState>,
    id_persona: i32,
    body: &CrearPersonaProveedorRecursosSchema,
